...
import { SLOT_COLORS } from "@/lib/util/color";
...
export function GameHud() {
    ...
    const { socket, connected, endTurn, abortGame } = useGameSocket();
        ...
        <div className="relative flex flex-col min-h-0">
            ...
            <div className="mt-auto mb-0">
                <div className="w-full">
                    ...
                    {isHostUser && (
                        <Button className="mb-2! w-full!" onClick={handleAbortGame}>
                            Abort game
                        </Button>
                    )}
                </div>
...
function PlayerSlot({ seat }: { seat: LobbySeatView }) {
    ...
    const color = SLOT_COLORS[seat.slot];
